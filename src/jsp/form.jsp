...
<body>
	...
	<div id="section">
		...
		<form name="mines_survey" id="mines_survey" method="post" action="dump.php">
	
			<input type="hidden" name="destination_url" id="destination_url" value="http://google.com">
			<input type="hidden" name="new_destination_url" id="new_destination_url" value="http://google.com">
			<input type="hidden" name="patron_location" id="patron_location" value="132.239.89.224">
			<input type="hidden" name="client_ip_param" value="132.239.120.133">	
			...
			<fieldset id="ye-olde-submit-button">
				...
				<input type="submit" name="submit" id="submit" value="Submit Survey" disabled="disabled">
			</fieldset>
